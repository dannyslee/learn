                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="procced-checkout">
                                <h4 class="procced-title text-uppercase pb-15 mb-20"><strong>我的账户列表</strong></h4>
                                <p>可以在下面的选框中查询相关的信息</p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                            <div class="panel-body">
                                                <div class="coupon-info">
                                                    <h6 class="procced-title text-uppercase pb-15 mb-20"> 订单列表 </h6>
                                                </div>
                                                <div id="showOrder">
...
<!--                                 
                            ...
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="myaccount-link-list" id="showItem">
