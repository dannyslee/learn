...
<!-- 									<div class="news-to-blog display-none">
										...
										<div class="about-middle-content">
											...
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusm jedo tempor incididunt ut labore et
												dolore magna aliqua enim ad inim </p>
										</div>
									</div> -->
								</div>
							</div>
							...
							<!-- <div class="login-account p-30 box-shadow"> -->
								<div class="row">
									...
									<div class="col-sm-6">
										<input type="text" placeholder="详细位置...">
									</div>
									<div class="col-sm-6">
										<br/>
										...
										<div class="col-sm-2">
											<button class="btn-default" type="button">提交订单</button>
										</div>
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="about-top-text">
									<h4 class="about-title mb-35"><span class="text-defualt">寄语</span> THE LARGEST COLLECTION FOR YOU</h4>
									<p>ge is the best online shop for your online shopping orem ipsum dolor sit amet, consectetur adipiscing elit,
									</p>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
										dolore magna aliqua. Ut enim ad minim nia, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
										comm.</p>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="footer-top-content">
									...
									<p class="pb-30">Forge is the best ecommerce site lorem ipsum dolor sit amet, consectetur aiscing elit, sed do
