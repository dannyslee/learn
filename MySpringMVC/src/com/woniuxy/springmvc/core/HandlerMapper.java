...
public class HandlerMapper{
	...
	private static Map<String,Object> controllerMappings = new HashMap<>();
	//存储请求映射与Menthod对应关系
	private static Map<String,Object> methodMappings = new HashMap<>();
	...
	public static Map<String, Object> getControllerMappings() {
		return controllerMappings;
	}


	public static Map<String, Object> getMethodMappings() {
